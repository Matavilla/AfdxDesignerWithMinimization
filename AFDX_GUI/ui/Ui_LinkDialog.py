...
class Ui_LinkDialog(object):
    def setupUi(self, LinkDialog):
        ...
        self.timelabel2 = QtGui.QLabel(self.layoutWidget)
        sizePolicy2 = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.timelabel.sizePolicy().hasHeightForWidth())
        self.timelabel2.setSizePolicy(sizePolicy2)
        self.timelabel2.setObjectName(_fromUtf8("timelabel2"))
        self.verticalLayout.addWidget(self.timelabel2)
        self.horizontalLayout_4 = QtGui.QHBoxLayout()
        self.horizontalLayout_4.setObjectName(_fromUtf8("horizontalLayout_4"))
        self.length = QtGui.QLineEdit(self.layoutWidget)
        self.length.setEnabled(True)
        self.length.setReadOnly(False)
    ...
    def retranslateUi(self, LinkDialog):
        ...
        self.timelabel2.setText(_translate("LinkDialog", "Length :", None))
